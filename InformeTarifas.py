...
# Asignar cada archivo a su clave según su nombre
if uploaded_files:
...
if all(file_dict.values()):
    try:
        with st.spinner("Procesando archivos..."):
            ...
            # Generar Tabla de Tarifas a partir de TC1
            required_columns = [
            ...
            if all(col in tc1_filtrado.columns for col in required_columns):
                ...
                # Asegurarse de que los NIU sean cadenas sin espacios
            ...
            # Actualizar la hoja "Consolidado" en el archivo de Informe_Tarifas
            try:
            ...
            # Validación y cruce con Bitácora
            ...
            # Preparar descarga de informes en un ZIP
